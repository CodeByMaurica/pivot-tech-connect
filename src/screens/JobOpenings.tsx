...
export default function JobOpenings() {
  ...
  function handleSearch() {
    ...
    setLocation(searchLocation || "United States");
  }
      ...
      <section className="indeed-style-search">
        <div className="indeed-search-bar">
          <label className="indeed-search-field">
            ...
            <input
              type="text"
              placeholder="Software developer, cybersecurity, data analytics"
              value={searchKeyword}
            ...
            <div>
              ...
              <p>
                {activeTab === "All Jobs" ? (
                  <>
                    Results for{" "}
                    <strong>{keyword || "multiple tech career paths"}</strong>{" "}
